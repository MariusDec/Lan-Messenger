...
FileView* lmcTransferListView::currentItem() {
    return pModel->item(currentRow());
}

int lmcTransferListView::currentRow() {
...
void lmcTransferListView::saveData(const QString &filePath, const FileView *transfer) {
    pModel->saveData(filePath, transfer);
}
