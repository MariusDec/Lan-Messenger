...
lmcUpdateWindow::lmcUpdateWindow(QRect* pRect, QWidget *parent) : QWidget(parent), ui(new Ui::UpdateWindow) {
    ...
    connect(ui->btnClose, &ThemedButton::clicked, this, &lmcUpdateWindow::close);
    connect(ui->btnRecheck, &ThemedButton::clicked, this, &lmcUpdateWindow::btnRecheck_clicked);
...
void lmcUpdateWindow::settingsChanged() {
}
...
void lmcUpdateWindow::btnRecheck_clicked() {
    checkForUpdates();
}

void lmcUpdateWindow::setUIText() {
