...
lmcHelpWindow::lmcHelpWindow(const QRect &pRect, QWidget *parent) : QWidget(parent) {
    ...
    ui.textBrowserHelp->installEventFilter(this);
    ui.buttonClose->installEventFilter(this);

    connect(ui.buttonClose, &ThemedButton::clicked, this, &lmcHelpWindow::close);
}
...
void lmcHelpWindow::setUIText() {
    ...
    QString html = tr(
        "<html>"
            ...
            "</body>"
        "</html>");
    ui.textBrowserHelp->setHtml(html.arg(helpLink, faqLink, supportLink));
}
